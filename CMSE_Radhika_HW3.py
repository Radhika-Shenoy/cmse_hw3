...
cancer_df[['radius_mean','texture_mean','concavity_mean','symmetry_se','diagnosis']] = cancer_df.apply(lambda r: ['radius_mean','texture_mean','concavity_mean','symmetry_se','diagnosis'], axis=1, result_type="expand")
